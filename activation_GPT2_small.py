...
while True:
    sentence_gpt2xl = input("Please input a sentence for GPT2-small(standard) model (type 'quit' to stop): ")
    if sentence_gpt2xl.lower() == 'quit':
        break
    process_sentence(model_gpt2xl, tokenizer_gpt2xl, sentence_gpt2xl, "GPT2-small")
